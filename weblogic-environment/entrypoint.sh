...
/u01/app/oracle/product/fmw/change_weblogic_password.sh $1 $2
...
(export JAVA_OPTIONS="$JAVA_OPTIONS -Dssl.debug=true -Dweblogic.security.SSL.ignoreHostnameVerification=true -Dweblogic.security.SSL.enforceConstraints=off" && /u01/app/oracle/product/fmw/user_projects/domains/basicWLSSDomain/startWebLogic.sh) 
