...
readTemplate("/u01/app/oracle/product/fmw/wlserver_10.3/common/templates/domains/wls.jar")
...
writeDomain('/u01/app/oracle/product/fmw/user_projects/domains/basicWLSSDomain')
closeTemplate()
